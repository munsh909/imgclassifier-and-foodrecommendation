...
import {
  ...
  usePrevious,
  useUncontrolled
} from "./chunk-ZDLAPCJZ.js";
import {
  require_classnames,
  useBootstrapPrefix
} from "./chunk-55HMTULW.js";
import {
  require_jsx_runtime
...
var TransitionWrapper = import_react2.default.forwardRef(({
  onEnter,
  onEntering,
  onEntered,
  onExit,
  ...
  const handleEnter = (0, import_react2.useCallback)(normalize(onEnter), [onEnter]);
  const handleEntering = (0, import_react2.useCallback)(normalize(onEntering), [onEntering]);
  const handleEntered = (0, import_react2.useCallback)(normalize(onEntered), [onEntered]);
  const handleExit = (0, import_react2.useCallback)(normalize(onExit), [onExit]);
  const handleExiting = (0, import_react2.useCallback)(normalize(onExiting), [onExiting]);
  const handleExited = (0, import_react2.useCallback)(normalize(onExited), [onExited]);
  const handleAddEndListener = (0, import_react2.useCallback)(normalize(addEndListener), [addEndListener]);
...
var NavbarCollapse = React5.forwardRef(({
  children,
  bsPrefix,
  ...props
}, ref) => {
...
var NavbarToggle = React6.forwardRef(({
  bsPrefix,
  className,
  children,
  ...
  const {
    onToggle,
    expanded
  } = (0, import_react7.useContext)(NavbarContext_default) || {};
...
var useIsomorphicEffect_default2 = isDOM || isReactNative ? import_react8.useLayoutEffect : import_react8.useEffect;
...
function useMediaQuery(query, targetWindow = typeof window === "undefined" ? void 0 : window) {
  ...
  const [matches, setMatches] = (0, import_react9.useState)(() => mql ? mql.matches : false);
...
function createBreakpointHook(breakpointValues) {
  ...
  function useBreakpoint2(breakpointOrMap, direction, window2) {
    ...
    let query = (0, import_react10.useMemo)(() => Object.entries(breakpointMap).reduce((query2, [key, direction2]) => {
...
function useWillUnmount(fn) {
  ...
  (0, import_react12.useEffect)(() => () => onUnmount.current(), []);
}
...
function NoopTransition({
  ...
  const hasEnteredRef = (0, import_react15.useRef)(inProp);
  ...
  const child = (0, import_react15.cloneElement)(children, {
    ref: combinedRef
  });
...
function useRTGTransitionProps(_ref) {
  ...
  const handleEnter = (0, import_react16.useCallback)(normalize(onEnter), [onEnter]);
  const handleEntering = (0, import_react16.useCallback)(normalize(onEntering), [onEntering]);
  const handleEntered = (0, import_react16.useCallback)(normalize(onEntered), [onEntered]);
  const handleExit = (0, import_react16.useCallback)(normalize(onExit), [onExit]);
  const handleExiting = (0, import_react16.useCallback)(normalize(onExiting), [onExiting]);
  const handleExited = (0, import_react16.useCallback)(normalize(onExited), [onExited]);
  const handleAddEndListener = (0, import_react16.useCallback)(normalize(addEndListener), [addEndListener]);
  return Object.assign({}, props, {
    ...
    ) : (0, import_react16.cloneElement)(children, {
      ref: mergedRef
    })
  });
}
...
var RTGTransition = React7.forwardRef((_ref, ref) => {
  let {
    component: Component
...
function useTransition({
  ...
  const isInitialRef = (0, import_react17.useRef)(true);
...
function ImperativeTransition({
  ...
  const [exited, setExited] = (0, import_react17.useState)(!inProp);
  if (inProp && exited) {
    setExited(false);
  }
  ...
  const combinedRef = useMergedRefs_default(ref, getChildRef(children));
  return exited && !inProp ? null : (0, import_react17.cloneElement)(children, {
    ref: combinedRef
  });
}
...
function useModalManager(provided) {
  ...
  const modal = (0, import_react18.useRef)({
    dialog: null,
    backdrop: null
  });
  return Object.assign(modal.current, {
    ...
    setDialogRef: (0, import_react18.useCallback)((ref) => {
      modal.current.dialog = ref;
    }, []),
    setBackdropRef: (0, import_react18.useCallback)((ref) => {
      modal.current.backdrop = ref;
    }, [])
  });
}
var Modal = (0, import_react18.forwardRef)((_ref, ref) => {
  let {
    show = false,
    role = "dialog",
    className,
  ...
  const [exited, setExited] = (0, import_react18.useState)(!show);
  const lastFocusRef = (0, import_react18.useRef)(null);
  (0, import_react18.useImperativeHandle)(ref, () => modal, [modal]);
  ...
  const removeFocusListenerRef = (0, import_react18.useRef)();
  const removeKeydownListenerRef = (0, import_react18.useRef)();
  ...
  return (0, import_jsx_runtime8.jsx)(import_jsx_runtime8.Fragment, {
    children: import_react_dom2.default.createPortal((0, import_jsx_runtime8.jsxs)(import_jsx_runtime8.Fragment, {
...
var OffcanvasBody = React11.forwardRef(({
  className,
  bsPrefix,
  as: Component = "div",
  ...props
...
var OffcanvasToggling = React12.forwardRef(({
  bsPrefix,
  className,
  children,
  in: inProp = false,
...
var CloseButton = React14.forwardRef(({
  className,
  variant,
...
var AbstractModalHeader = React15.forwardRef(({
  closeLabel = "Close",
  closeVariant,
  closeButton = false,
  onHide,
...
var OffcanvasHeader = React16.forwardRef(({
  bsPrefix,
  className,
  closeLabel = "Close",
  closeButton = false,
...
var divWithClassName_default = (className) => (
  ...
  React17.forwardRef((p, ref) => (0, import_jsx_runtime16.jsx)("div", {
    ...p,
    ref,
...
var OffcanvasTitle = React18.forwardRef(({
  className,
  bsPrefix,
...
var Offcanvas = React19.forwardRef(({
  bsPrefix,
  className,
  children,
  ...
  const modalManager = (0, import_react21.useRef)();
  bsPrefix = useBootstrapPrefix(bsPrefix, "offcanvas");
  const [showOffcanvas, setShowOffcanvas] = (0, import_react21.useState)(false);
  ...
  const renderBackdrop = (0, import_react21.useCallback)((backdropProps) => (0, import_jsx_runtime18.jsx)("div", {
    ...backdropProps,
...
var NavbarOffcanvas = React20.forwardRef(({
  onHide,
  ...props
}, ref) => {
  const context = (0, import_react22.useContext)(NavbarContext_default);
...
var NavbarText = React21.forwardRef(({
  className,
  bsPrefix,
  as: Component = "span",
  ...props
...
var Navbar = React22.forwardRef((props, ref) => {
  const {
  ...
  const handleCollapse = (0, import_react23.useCallback)((...args) => {
  ...
  const navbarContext = (0, import_react23.useMemo)(() => ({
