...
import {
  ...
  usePrevious,
  useUncontrolled
} from "./chunk-CD7UMMBP.js";
import {
  require_classnames,
  useBootstrapPrefix,
  useIsRTL
} from "./chunk-ZS4MFPRX.js";
import {
  require_jsx_runtime
...
var DropdownToggle2 = React14.forwardRef(({
  bsPrefix,
  split,
  className,
  childBsPrefix,
...
var Dropdown2 = React15.forwardRef((pProps, ref) => {
  const {
    bsPrefix,
    drop = "down",
    show,
  ...
  return (0, import_jsx_runtime12.jsx)(DropdownContext_default2.Provider, {
    value: contextValue,
    children: (0, import_jsx_runtime12.jsx)(Dropdown_default, {
      placement,
      show,
      onSelect,
      ...
      children: isInputGroup ? props.children : (0, import_jsx_runtime12.jsx)(Component, {
        ...props,
        ref,
...
var NavDropdown = React16.forwardRef(({
  id,
  title,
  children,
  bsPrefix,
  ...
  return (0, import_jsx_runtime14.jsxs)(Dropdown_default2, {
    ref,
    ...props,
    className: (0, import_classnames9.default)(className, navItemPrefix),
    children: [(0, import_jsx_runtime13.jsx)(Dropdown_default2.Toggle, {
      id,
      eventKey: null,
      active,
      disabled,
      ...
      as: NavLink_default,
      children: title
    }), (0, import_jsx_runtime13.jsx)(Dropdown_default2.Menu, {
      role: menuRole,
